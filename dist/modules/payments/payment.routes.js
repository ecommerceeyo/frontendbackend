...
import { initiatePaymentSchema } from '../../validations';
const router = Router();
/**
 ...
 * @access  Public
 */
router.post('/initiate', checkoutLimiter, validate(initiatePaymentSchema, 'body'), paymentController.initiatePayment);
/**
 ...
 * @access  Public
 */
router.get('/verify/:transactionId', checkoutLimiter, paymentController.verifyPayment);
