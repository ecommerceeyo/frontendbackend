...
router.get('/staff', authenticateSupplier, requireActiveSupplier, requireSupplierRole('OWNER', 'MANAGER'), supplierAuthController.getStaff);
router.post('/staff', authenticateSupplier, requireActiveSupplier, requireSupplierRole('OWNER', 'MANAGER'), supplierAuthController.createStaff);
router.patch('/staff/:staffId/status', authenticateSupplier, requireActiveSupplier, requireSupplierRole('OWNER', 'MANAGER'), supplierAuthController.updateStaffStatus);
router.delete('/staff/:staffId', authenticateSupplier, requireActiveSupplier, requireSupplierRole('OWNER'), supplierAuthController.deleteStaff);
